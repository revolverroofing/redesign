  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/80">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-4 px-6">
        ...
        <nav
          aria-label="Primary"
          className="hidden gap-8 text-sm font-medium text-zinc-700 sm:flex dark:text-zinc-300"
        >
          {navLinks.map((link) => (
            <a
              key={link.href}
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="hidden text-sm font-semibold text-zinc-900 hover:text-orange-600 sm:inline dark:text-zinc-100"
